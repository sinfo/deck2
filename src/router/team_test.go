...
func TestGetTeamsPublic(t *testing.T) {
	...
	assert.Equal(t, containsTeamPublic(teams, Team2), true)
}

func TestGetTeamsPublicByName(t *testing.T) {
...
func TestGetTeamsPublicBadQuery(t *testing.T) {

	var badQuery1 = "?event=wrong"
	var badQuery2 = "?member=wrong"

	res1, err1 := executeRequest("GET", "/public/teams"+badQuery1, nil)
	res2, err2 := executeRequest("GET", "/public/teams"+badQuery2, nil)
	assert.NilError(t, err1)
	assert.NilError(t, err2)
...
func TestGetTeamPublic(t *testing.T) {
...
func TestGetTeamPublicBadID(t *testing.T) {
